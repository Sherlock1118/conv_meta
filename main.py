...
#                         help='Number of epochs to train MF and Transfer,outer loop for SML.')
    ...
    parser.add_argument('--pt', type=str, default='20220916',  # outer loop
                        help='Number of epochs to train MF and Transfer,outer loop for SML.')
    parser.add_argument('--num_heads', type=int, default=4,  # 1 or 2
    ...
    **********************************************************************************************
    ...
    parser.add_argument('--bridge_batch_size', type=int, default=128,
                        help='batch size for MF training, step in SML.')
    parser.add_argument('--bridge_input_dim', type=int, default=64,
                        help='batch size for MF training, step in SML.')
    parser.add_argument('--bridge_output_dim', type=int, default=64,
                        help='batch size for MF training, step in SML.')
