...
#         self.dataset_conv_meta = dataset_meta_conv
        ...
        self.train_dataset_builder = DatasetBuilder(input_table=args.input_table_train,\
             partitions=f'pt={args.pt}', column_spec=spec).to_pandas()
        self.test_dataset_builder = DatasetBuilder(input_table=args.input_table_test, \
            partitions=f'pt={args.pt}', column_spec=spec).to_pandas()
    ...
    def get_each_dataset(self, mode=None):
        if mode == 'support':
            ...
            del s_usr_embed_df, s_item_embed_df, t_usr_cat_df, t_usr_num_df, t_item_cat_df, t_item_num_df, label_df, t_usr_cat_df_prep, t_usr_df, t_item_df
